...
void addition_matrix(matrix_t *res_matrix, matrix_t *matrix, matrix_t *matrix_2)
{
...
int addition(char *file_1, char *file_2, char *res)
{
    int error_code = OK;
    ...
    res_matrix.columns = matrix_1.columns;
    ...
    addition_matrix(&res_matrix, &matrix_1, &matrix_2);
